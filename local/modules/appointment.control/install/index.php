...
Class appointment_control extends CModule
{
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "appointment.control";
    var $MODULE_ID = "appointment.control";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("appointment.control_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("appointment.control_MODULE_DESC");

        $this->PARTNER_NAME = GetMessage("appointment.control_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("appointment.control_PARTNER_URI");
    }
